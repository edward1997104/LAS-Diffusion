...
python generate.py --model_path ./checkpoints/Thingi10K/epoch\=3999.ckpt --generate_method generate_unconditional --num_generate 16 --steps 50
python generate_super_resolution.py --model_path ./checkpoints/shape_super/epoch\=499.ckpt --generate_method generate_meshes --npy_path ./outputs/Thingi10K_epoch\=3999.ckpt_True_50_0.0_unconditional --save_npy True --save_mesh True --level 0.0 --steps 20
